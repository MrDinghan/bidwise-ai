...
/**
 * Stateless security: public auth + docs + health endpoints, everything else
 * requires a valid JWT injected by {@link JwtAuthenticationFilter}.
 */
@Configuration
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(
                                ...
                                "/swagger-ui/**",
                                "/swagger-ui.html",
                                // Payment webhooks authenticate via signature, not JWT.
                                "/api/webhooks/**",
